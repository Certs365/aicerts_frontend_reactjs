    ...
    <div className="login_wrapper d-flex flex-row">
      ...
      <div className="d-none d-lg-flex flex-column login_banner_wrapper">
        ...
        <div className="banner_text_wrapper">
          <h3 className="fs-24-12 fw-600 mb-4">
            Generate up to 2000 certificates at once
          </h3>
          <p className="fs-18-12 grey-light">
            Certs365: Empowering Blockchain Certification and Document Issuance
            (CertiDocIssuance) - Over 10,000+ Credentials Issued, 7,000+
            Verified, Supporting Batch Issuance of 2,000 Credentials,
            Certificate Design, Lifecycle Management, Analytics, and Multi-Chain
      ...
      {/* Form Section */}
      <div className="login_form_wrapper d-flex flex-column text-center">
        {!showVerify ? (
          <>
            ...
            <form onSubmit={handleLoginSubmit}>
              ...
              <div className="d-flex flex-row justify-content-between">
                ...
                <Link href="/forgot-passwords">
                  <p className="fs-16-14 golden pointer underline">
                    Forgot Password?
                  </p>
                </Link>
              </div>
